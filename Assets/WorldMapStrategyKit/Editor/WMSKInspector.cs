    ...
    public class WMSKInspector : Editor {
        ...
        void OnEnable() {
            ...
            earthStyleOptions = new string[] {
                "Solid Color", "Texture", "Natural", "Natural HighRes", "Natural HighRes 16K", "Alternate Style 1", "Alternate Style 2", "Alternate Style 3", "Scenic", "Scenic 8K", "Viewport Scenic Plus", "Viewport Scenic Plus Alt 1", "Viewport Scenic Plus 16K"
            };
