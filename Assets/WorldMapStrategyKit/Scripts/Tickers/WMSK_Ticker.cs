...
namespace WorldMapStrategyKit {
	...
	public class WMSK_Ticker : MonoBehaviour {
		...
		public void AddTickerText(TickerText tickerText) {
			...
			GameObject tickerTextObj = Drawing.CreateText(tickerText.text, null, pos, customFont, tickerText.textColor, tickerText.drawTextShadow, customShadowMaterial, tickerText.shadowColor, tickerText.shadowOffset, tickerText.anchor).gameObject;
