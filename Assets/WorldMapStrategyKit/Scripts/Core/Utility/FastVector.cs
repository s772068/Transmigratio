...
namespace WorldMapStrategyKit {
	public static class FastVector {
		...
		/// <param name="result">Result.</param>
		public static void CombineAndNormalize(ref Vector3 up, float a, ref Vector3 right, float b, ref Vector3 result) {
			float x = up.x * a + right.x * b;
			float y = up.y * a + right.y * b;
			float z = up.z * a + right.z * b;
