...
namespace WorldMapStrategyKit {
	...
	public static class Conversion {
		...
		/// <summary>
		/// Returns lat/lon coordinates from local position (x=lat, y=lon)
		/// </summary>
		...
		/// <summary>
		/// Returns distance in meters between two map coordiantes
		/// </summary>
		public static float Distance(Vector2 position1, Vector2 position2)
		{
			Vector2 latLon1 = GetLatLonFromLocalPosition(position1);
            Vector2 latLon2 = GetLatLonFromLocalPosition(position2);
