...
namespace WorldMapStrategyKit {
    ...
    public partial class WMSK : MonoBehaviour {
        ...
        public bool allowInteractionWhileFlying {
            ...
            set { _allowInteractionWhileFlying = value; isDirty = true; }
        }
        ...
        public float staticInteractionVelocityThreshold {
            ...
            set { _staticInteractionVelocityThreshold = value; isDirty = true; }
        }
        ...
        public void RectangleSelectionCancel() {
            RectangleSelection[] rrss = GetComponentsInChildren<RectangleSelection>(true);
        ...
        public bool rectangleSelectionInProgress {
            get {
                RectangleSelection rs = GetComponentInChildren<RectangleSelection>();
                return rs != null;
            }
        }
