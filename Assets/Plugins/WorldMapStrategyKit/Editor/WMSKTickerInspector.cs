...
namespace WorldMapStrategyKit {
	...
	public class WMSKTickerInspector : Editor {
		...
		public override void OnInspectorGUI () {
			...
			EditorGUILayout.BeginHorizontal ();
			GUILayout.Label ("   Anchor", GUILayout.Width (120));
			sampleTicker.anchor = (TextAnchor)EditorGUILayout.EnumPopup (sampleTicker.anchor);
			EditorGUILayout.EndHorizontal ();
			...
			if (sampleTicker.drawTextShadow) {
				sampleTicker.shadowColor = EditorGUILayout.ColorField ("   Shadow Color", sampleTicker.shadowColor);
				sampleTicker.shadowOffset = EditorGUILayout.Vector2Field("   Shadow Offset", sampleTicker.shadowOffset);
			}
